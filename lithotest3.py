...
if uploaded_file and len(pozos_data) > 0:
    ...
    # Graficar los resultados de clustering para cada pozo en columnas
    def graficar_clustering_columnas(pozos_ordenados, resultados_clustering, profundidad_min, profundidad_max, clusters_filtrados):
        ...
        for i, pozo in enumerate(pozos_ordenados):
            ...
            # Graficar los resultados del clustering como facies
    ...
    if len(orden_pozos) > 0:
        fig = graficar_clustering_columnas(orden_pozos, clustering_results, profundidad_min, profundidad_max, clusters_filtrados)
        st.pyplot(fig)
    else:
